...
public class PinPromptFragment extends Fragment {
    ...
    public static PinPromptFragment newInstance(final Params params) {
        Bundle args = new Bundle();
        args.putSerializable(PARAMS_KEY, params);
        PinPromptFragment fragment = new PinPromptFragment();
