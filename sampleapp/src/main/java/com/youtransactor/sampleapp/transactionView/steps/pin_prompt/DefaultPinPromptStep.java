...
import com.youtransactor.sampleapp.transactionView.components.PinPromptFragment;

public class DefaultPinPromptStep implements PinPromptStep {

    private final TransactionViewBase transactionViewBase;

    public DefaultPinPromptStep(TransactionViewBase transactionViewBase) {
    ...
    public void execute(EventCommand genericCommand) {
        ...
        final PinPromptFragment.Params params = new PinPromptFragment.Params(
                eventCmd.getMessage(),
                eventCmd.getMessageId(),
                true
        );
        final PinPromptFragment fragment = PinPromptFragment.newInstance(params);
