...
import com.youtransactor.sampleapp.transactionView.components.WaitCardStickFragment;

public class StickWaitCardStep implements WaitCardStep {

    private final TransactionViewBase transactionViewBase;

    public StickWaitCardStep(TransactionViewBase transactionViewBase) {
    ...
    public void execute(EventCommand genericCommand) {
        ...
        final WaitCardStickFragment.Params params = new WaitCardStickFragment.Params(
                eventCmd.getAmount(),
                eventCmd.getMessage(),
                eventCmd.getInterfaces()
        );
        final WaitCardStickFragment fragment = WaitCardStickFragment.newInstance(params);
