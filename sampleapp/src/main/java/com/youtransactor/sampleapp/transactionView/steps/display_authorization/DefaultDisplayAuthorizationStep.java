...
package com.youtransactor.sampleapp.transactionView.steps.display_authorization;
...
public class DefaultDisplayAuthorizationStep implements DisplayAuthorizationStep {

    private final TransactionViewBase transactionViewBase;

    public DefaultDisplayAuthorizationStep(TransactionViewBase transactionViewBase) {
        this.transactionViewBase = transactionViewBase;
    }

    @Override
    public void execute(EventCommand genericCommand) {
        final EventDspAuthorisation eventCmd = (EventDspAuthorisation) genericCommand;
