...
package com.youtransactor.sampleapp.transactionView.steps.display_idle;
...
public class DefaultDisplayIdleStep implements DisplayIdleStep {

    private final TransactionViewBase transactionViewBase;

    public DefaultDisplayIdleStep(TransactionViewBase transactionViewBase) {
        this.transactionViewBase = transactionViewBase;
    }

    @Override
    public void execute(EventCommand genericCommand) {
        this.transactionViewBase.backToHomeFragment();
    }
}