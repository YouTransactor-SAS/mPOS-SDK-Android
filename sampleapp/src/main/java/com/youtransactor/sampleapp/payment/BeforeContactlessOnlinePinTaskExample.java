...
import com.youTransactor.uCube.payment.task.IBeforeContactlessOnlinePinTask;

public class BeforeContactlessOnlinePinTaskExample implements IBeforeContactlessOnlinePinTask {

    private final static String TAG = BeforeContactlessOnlinePinTaskExample.class.getSimpleName();
    ...
    public BeforeContactlessOnlinePinTaskExample(final TaskAction taskAction) {
